    ...
    <section class="content">
        ...
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Yeni Operasyon Ekle</h3>
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('urun.operasyonStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-4">
                        <label>Operasyon Kodu</label>
                        <input type="text" class="form-control" name="operasyonKod" placeholder="Operasyon kodu">
                    </div>
                    <div class="form-group col-md-4">
                        <label>Operasyon Adı</label>
                        <input type="text" class="form-control" name="operasyonAd" placeholder="Operasyon adı">
                    </div>
                    <div class="form-group col-md-4">
            ...
            <div class="box-footer pull-right box-tools">
                <button type="submit" class="btn btn-success">Operasyon Kaydet</button>
            </div>
            </form>
        </div>
        <!-- /.box-body -->
