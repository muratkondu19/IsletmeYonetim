    ...
    <section class="content">
        ...
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Yeni İş Merkezi Ekle</h3>
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('urun.ismerkeziStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-6">
                        <label>İş Merkezi Kodu</label>
                        <input type="text" class="form-control" name="ismerkeziKod" placeholder="İş Merkezi kodu">
                    </div>
                    <div class="form-group col-md-6">
                        <label>İş Merkezi Adı</label>
                        <input type="text" class="form-control" name="ismerkeziAd" placeholder="İş Merkezi adı">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="box-footer pull-right box-tools">
                        <button type="submit" class="btn btn-primary">İş Merkezi Kaydet</button>
                    </div>
                </form>
            </div>
