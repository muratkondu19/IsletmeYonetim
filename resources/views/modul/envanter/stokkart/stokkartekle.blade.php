    ...
    <section class="content">
        ...
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Yeni Stok Kart Ekle</h3>
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('envanter.stokkartStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-6">
                        <label>Stok Kodu</label>
                        <input type="text" class="form-control" name="stokKod" placeholder="Stok kodu">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Stok Adı</label>
                        <input type="text" class="form-control" name="stokAd" placeholder="Stok adı">
                    </div>
                    <div class="form-group col-md-6">
                                ...
                                <tr class="islem_field">
                                    ...
                                    <td>
                                        <select name="stokMHK" class="form-control mhk">
                                            ...
                                            <option data-mhk="{{ $v['hesapAd'] }}" value="{{ $v['hesapKod'] }}">
                                    ...
                                    <td><select name="stokMHA" class="form-control mha">
                                            <option selected>Muhasebe Hesap Adı Seçiniz</option>
                                                @foreach (\App\Models\Muhasebe\HesapKod::all() as $k => $v)
                                            <option data-mha="{{ $v['hesapKod'] }}" value="{{ $v['hesapAd'] }}">
...
@section('footer')
    ...
    <script>
        $(document).ready(function() {
            ...
            var mhk = $(this).find(":selected").data("mhk");
            $(this).closest(".islem_field").find(".mha").val(mhk)
        })

        $("body").on("change", ".mha", function() {
            var mha = $(this).find(":selected").data("mha");
