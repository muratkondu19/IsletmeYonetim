    ...
    <section class="content">
        ...
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Yeni Banka Ekle</h3>
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('muhasebe.bankaStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-6">
                        <label>Banka Kodu</label>
                        <input type="text" class="form-control" name="bankaKod" placeholder="Banka kodu">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Banka Adı</label>
                        <input type="text" class="form-control" name="bankaAd" placeholder="Banka adı">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Hesap Numarası</label>
                        <input type="text" class="form-control" name="bankaHN" placeholder="Hesap numarası">
                    </div>
                    <div class="form-group col-md-6">
                        <label>IBAN</label>
                        <input type="text" class="form-control" name="bankaIBAN" placeholder="IBAN">
                    </div>
                    <div class="form-group col-md-12">
                        <label>Hesap Adı</label>
                        <input type="text" class="form-control" name="bankaHesapAd" placeholder="Hesap adı">
                    </div>
                    <div class="form-group col-md-12">
                    ...
                    <div class="box-footer pull-right box-tools">
                        <button type="submit" class="btn btn-success">Banka Kaydet</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
