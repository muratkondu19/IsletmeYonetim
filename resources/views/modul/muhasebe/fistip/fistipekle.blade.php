    ...
    <section class="content">
        ...
        <div class="box box-danger">
            <div class="box-header">
                <h3 class="box-title">Yeni Fiş Tipi Ekle</h3>
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('muhasebe.fistipStore') }}" method="POST" role="form"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-6">
                        <label>Fiş Tipi Kodu</label>
                        <input type="text" class="form-control" name="fisTipKod" placeholder="Fiş Tipi Kodu">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Fiş Tipi Adı</label>
                        <input type="text" class="form-control" name="fisTipAd" placeholder="Fiş Tipi Adı">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="box-footer pull-right box-tools">
                        <button type="submit" class="btn btn-success">Fiş Tipi Kaydet</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
