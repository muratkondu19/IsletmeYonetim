    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{route('muhasebe.islemtipUpdate',['id'=>$data[0]['id']])}}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-12">
                        <label>İşlem Tipi Kodu</label>
                        <input type="text" class="form-control" name="islemtipKod" value=" {{$data[0]['islemTipKod']}} ">
                    </div>
                    <div class="form-group col-md-12">
                        <label>İşlem Tipi Adı</label>
                        <input type="text" class="form-control" name="islemtipAd"  value="{{$data[0]['islemTipAd']}}" >
                    </div>
                    <div class="form-group col-md-12">
                        <label>Kaynak</label>
                    ...
                    <div class="box-footer pull-right box-tools">
                        <button type="submit" class="btn btn-success">İşlem Tipi Güncelle</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
