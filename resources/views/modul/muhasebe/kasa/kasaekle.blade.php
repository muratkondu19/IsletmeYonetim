    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('muhasebe.kasaStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group col-md-12">
                        <label>Kasa Kodu</label>
                        <input type="text" class="form-control" name="kasaKod" placeholder="Kasa kodu">
                    </div>
                    <div class="form-group col-md-12">
                        <label>Kasa Adı</label>
                        <input type="text" class="form-control" name="kasaAd" placeholder="Kasa adı">
                    </div>
                    <div class="form-group col-md-12">
                                ...
                                <tr class="islem_field">
                                    ...
                                    <td>
                                        <select name="kasaMHK" class="form-control  mhk">
                                            ...
                                            <option data-hk="{{ $v['hesapKod'] }}" value="{{ $v['hesapAd'] }}">
                                    ...
                                    <td><select name="kasaMHA" class="form-control  mha">
                                            <option selected>Muhasebe Hesap Adı Seçiniz</option>
                                                @foreach (\App\Models\Muhasebe\HesapKod::all() as $k => $v)
                                            <option data-ha="{{ $v['hesapAd'] }}" value="{{ $v['hesapKod'] }}">
                    ...
                    <div class="box-footer pull-right box-tools">
                        <button type="submit" class="btn btn-success">Kasa Kaydet</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
