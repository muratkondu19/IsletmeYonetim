    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('satis.satissiparisStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="satisSiparisBelgeNo" placeholder="Belge numarası giriniz.">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="satisSiparisAciklama" placeholder="Açıklama giriniz.">
                    </div>
                    ...
                    <div class="box-footer pull-right box-tools">
                        <button type="submit" class="btn btn-success">Satış Siparişi Kaydet</button>
                    </div>
                </form>
            </div>
            <!-- /.box-body -->
