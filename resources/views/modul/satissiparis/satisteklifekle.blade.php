    ...
    <section class="content">
        ...
        <div class="box box-danger">
            ...
            <div class="box-body">
                ...
                @endif
                <form action="{{ route('satis.satisteklifStore') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="satisTeklifBelgeNo" placeholder="Belge numarası giriniz.">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Teklif Tarihi</label>
                        <input type="date" value="{{ date('Y-m-d') }}" class="form-control" name="satisTeklifTarih">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Teklif Hareket Kodu</label>
                        <select name="satisTeklifHareketKod" class="form-control select2" style="width: 100%">
                            <option value="Satış Teklifi">Satış Teklifi</option>
                            <option value="İhracat Kayıtlı Satış Teklif">İhracat Kayıtlı Satış Teklif</option>
                            <option value="İhracat Satış Teklif">İhracat Satış Teklif</option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="satisTeklifAciklama" placeholder="Açıklama giriniz.">
                    </div>
